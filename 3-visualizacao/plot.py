...
def plot_both(args):
    view_lib.plot_both(args.img_file_or_dir, args.ann_file, args.pred_dir, args.out_dir)
...
if __name__ == '__main__':
    ...
    parser_ann.set_defaults(func=plot_annotations)
    ...
    parser_both.set_defaults(func=plot_both)
